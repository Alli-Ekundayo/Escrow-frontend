...
### Users
Freelancers and clients doing project-based work. They use Es-crow when starting paid work with someone they may not fully trust yet, and need a fast, clear way to place funds in escrow before delivery begins.

### Brand Personality
Trustworthy, clear, and fast. The interface should reduce anxiety, remove ambiguity, and make funding status obvious at every step.

### Aesthetic Direction
Refined fintech clarity with warm neutral surfaces and a decisive green action language. Information density should stay moderate and scannable for MVP polish. Avoid playful ornament, noisy visual effects, and ambiguous status messaging.

### Design Principles
1. Make payment state legible in one glance: awaiting funding, verifying, funded.
2. Keep the happy path short and explicit: one primary next action per state.
3. Pair every critical action with immediate status feedback and clear recovery guidance.
4. Use consistent status language and tokens across agreement details and funding screens.
5. For MVP polish, prioritize reliability and clarity over decorative complexity.